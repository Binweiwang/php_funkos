...
<body>
    ...
    <table class="table table-striped">
        ...
        $categoriesService = new CategoriasService($config->db);
        $categories = $categoriesService->findAll();
        ?>
        <?php foreach ($funkos as $funko): ?>
            <tr>
                <td><?php echo htmlspecialchars($funko->id); ?></td>
                <td><?php echo htmlspecialchars($funko->marca); ?></td>
                <td><?php echo htmlspecialchars($funko->modelo); ?></td>
                ...
                <td>
                    <?php
                    $category = $categoriesService->findById($funko->categoriaId);
                        echo "<span class='badge badge-secondary'>{$category->nombre}</span> ";
                    ?>
                <td>
                    ...
                    <a class="btn btn-danger btn-sm"
                       ...
                       onclick="return confirm('¿Estás seguro/a de que quieres eliminar este funko?');">
                        Eliminar
                    </a>
                </td>
            </tr>
